...
const variants = {
  ...
  icon:
    "h-[36px] px-2 rounded-full bg-transparent border-transparent hover:bg-hover active:border-interactive disabled:text-subdued disabled:bg-interactive-inverse focus:outline-none",
};
